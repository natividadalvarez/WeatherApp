...
However netlify serverless functions won't work locally unless you run the application with `netlify dev` from the netlify CLI.
...
# Application Details
A user can either input their location in the text input provided, or use the "use my locaton" button to allow the app to get their location via
